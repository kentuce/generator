...
public class Context extends PropertyHolder {
    ...
    /**
     * This method does a simple validate, it makes sure that all required fields have been filled in. It does not do any more complex operations such as validating that database tables exist or validating that named
     * columns exist
     *
    ...
    /**
     * Builds an XmlElement representation of this context. Note that the XML may not necessarily validate if the context is invalid. Call the <code>validate</code> method to check validity of this context.
     *
